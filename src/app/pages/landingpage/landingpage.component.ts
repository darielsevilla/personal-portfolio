...
@Component({
  ...
  imports: [NavbarComponent, MatGridListModule, MatGridList, MatGridTile, MatButtonModule, ServiceCardComponent, ProjectCardComponent, LanguageSelectComponent, CertificateCardComponent],
